...
public interface AssignmentRepository extends JpaRepository<Assignment, Long> {
    ...
    @Query("""
        ...
        a.startTime, a.endTime, a.passed, a.addedDate, a.updatedDate) from Assignment a where a.preparedBy.id = ?1 and a.passed = false and
    ...
    @Query("""
        select new com.edusyspro.api.dto.custom.AssignmentEssential(a.id, a.semester.semestre.semesterName, a.exam.examType,
        a.preparedBy, a.classeEntity.name, a.classeEntity.grade.section, a.subject.course, a.subject.abbr, a.examName, a.examDate,
        a.startTime, a.endTime, a.passed, a.addedDate, a.updatedDate) from Assignment a where a.preparedBy.id = ?1 and
        a.semester.semestre.academicYear.current = true order by a.examDate desc
    """)
    ...
    @Query("""
        select new com.edusyspro.api.dto.custom.AssignmentEssential(a.id, a.semester.semestre.semesterName, a.exam.examType,
        a.preparedBy, a.classeEntity.name, a.classeEntity.grade.section, a.subject.course, a.subject.abbr, a.examName, a.examDate,
        a.startTime, a.endTime, a.passed, a.addedDate, a.updatedDate) from Assignment a where a.preparedBy.id = ?1 and a.classeEntity.id = ?2 and a.subject.id = ?3
    ...
    @Query("""
        select new com.edusyspro.api.dto.custom.AssignmentEssential(a.id, a.semester.semestre.semesterName, a.exam.examType,
        a.preparedBy, a.classeEntity.name, a.classeEntity.grade.section, a.subject.course, a.subject.abbr, a.examName, a.examDate,
        a.startTime, a.endTime, a.passed, a.addedDate, a.updatedDate) from Assignment a where a.preparedBy.id = ?1 and a.classeEntity.id = ?2
        and a.semester.semestre.academicYear.current = true order by a.examDate desc
    """)
